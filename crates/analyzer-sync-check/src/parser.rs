...
static FILE_EXTENSIONS: &[&str] = &[
    ".md", ".rs", ".ts", ".tsx", ".js", ".jsx", ".py", ".go", ".java", ".json", ".yml", ".yaml",
    ".toml", ".lock", ".txt", ".sh", ".bash", ".css", ".scss", ".html", ".svg", ".png", ".jpg",
    ".gif", ".exe", ".dll", ".so", ".wasm", ".cfg", ".ini", ".env", ".sum", ".mod", ".log", ".xml",
    ".csv", ".csproj", ".gemspec", ".swift", ".gradle", ".sln", ".plist", ".scm", ".el", ".vim",
    ".ps1",
];

/// Common TLDs - dot-separated words ending in these are likely URLs.
static URL_TLDS: &[&str] = &[
    ".com", ".org", ".net", ".io", ".dev", ".co", ".ai", ".app", ".rs", ".js", ".py", ".sh",
];
...
static STDLIB_PREFIXES: &[&str] = &[
    "Object", "Array", "JSON", "Math", "Date", "Promise", "String", "Number", "Boolean", "RegExp",
    "Error", "Map", "Set", "Symbol", "console", "process", "Buffer", "global", "window",
    "document", "fs", "path", "os", "util", "http", "https", "crypto",
];
